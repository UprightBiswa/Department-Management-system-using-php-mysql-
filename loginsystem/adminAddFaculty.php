<?php   
 include 'dbconnect.php';
  ...
  if(isset($_POST['submit'])){
    ...
    $sql = "INSERT into faculty(`username`,`email`,`mobile`,`password`,`address`,`gender`,`subject`)values('$name','$email','$mobile','$password','$address','$gender','$subject')";
            ...
            <div>
                <form method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter your Address" name="subject"
                            autocomplete="off">
                    </div>
                    <br>
                    <p>
