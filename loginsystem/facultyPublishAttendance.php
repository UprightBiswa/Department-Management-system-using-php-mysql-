...
<head>
    <meta charset="UTF-8" />
    <title>Faculty Attendance Percentage</title>
            ...
            <div class="container1">
                    ...
                    <table class="table">
                        ...
                        <tbody id="all-tasks">
                            <tr>
                                ...
                                <td><input type="number" style=" height: 25px; width: 104px; font-size: 15px; align-text: center;" placeholder="%"></td>
                            </tr>
                ...
                <center><button
                        ...
                        class="btn" onclick="window.location.href='';"><i
                            class="fa fa-upload">&emsp;Upload Attendance</i>
                    </button><center>
