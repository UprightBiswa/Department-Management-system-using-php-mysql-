...
<head>
    <meta charset="UTF-8" />
    <title>Admin Publish Grade</title>
    ...
    ?>
        ...
        <section class="main">
            ...
            <div class="container1">
                ...
                <td>
                    ...
                    <input type="tel" style=" height: 25px; width: 140px; font-size: 15px; align-text: center;" placeholder="Grade" name="grade" required>
        ...
        ?>
                            <!-- <tr>
                                ...
                                <td><input type="text" style=" height: 25px; width: 104px; font-size: 15px; align-text: center;" placeholder="Grade"></td>
                            </tr> -->
