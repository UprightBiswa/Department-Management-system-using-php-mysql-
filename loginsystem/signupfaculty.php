...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(($password == $cpassword) && $exists==false){
       ...
       $sql2=" INSERT INTO `faculty`( `id`,`username`, `password`) VALUES ('$id','$username','$password')";
...
<head>
	...
	<link href="css/style.css" rel="stylesheet">
			...
			<body>
				...
				<div class="form-box">
					<div class="header-text">Faculty Signup Form</div>
					<form action="signupfaculty.php" method="post">
