    ...
    ?>
        ...
        <section class="main">
                ...
                <form method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" style="height: 400%; width:37%; padding:1%"
                            placeholder="Enter your Enrollment Number" name="enumber" autocomplete="off" required>
            ...
            <div class="form-group">
                ...
                <label><b>Date Of Birth</b></label>&emsp;
                <input type="date" class="form-control" style="height: 500%; width:20.6%; padding:1%;"
